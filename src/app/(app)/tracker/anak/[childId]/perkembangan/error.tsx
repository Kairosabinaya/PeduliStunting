...
/**
 * Segment-level error boundary for the developmental-milestone sub-route.
 * Isolates a fetch/render failure so the child-detail layout stays usable and
 * only this panel shows the recovery affordance.
 */
export default function MilestoneErrorBoundary({
  error,
  reset,
