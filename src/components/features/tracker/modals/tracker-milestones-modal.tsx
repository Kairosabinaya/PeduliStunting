...
export interface TrackerMilestonesModalProps {
  readonly childId: string;
}

export async function TrackerMilestonesModal({
  childId,
}: TrackerMilestonesModalProps) {
  ...
  if (!childResult.ok) {
    return (
      <TrackerModal title={MILESTONE_COPY.metaTitleSuffix}>
        <ErrorState
  ...
  return (
    <TrackerModal title={MILESTONE_COPY.metaTitleSuffix} variant="sheet">
