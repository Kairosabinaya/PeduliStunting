...
export const CHOROPLETH_COPY = {
  ...
  body: "Setiap wilayah punya cerita berbeda. Geser layar dan saksikan 514 kabupaten/kota mengisi peta — dari yang sudah terkendali hingga yang masih berjuang.",
  bodyFootnoteId: "fn-prevalence",
  counterLabel: "balita masih mengalami stunting di Indonesia",
...
export const CONNECTIVE_BEATS = {
  humanCost: {
    ...
    lines: [
      "Di balik 1 dari 5 itu ada anak —",
      "mungkin tetanggamu, mungkin keponakanmu.",
    ],
    highlight: "ada anak",
  ...
  inequity: {
    ...
    lines: [
      "Sejak 2013 prevalensi memang turun.",
      "Tapi 1 dari 5 anak belum — dan bebannya tidak merata.",
    ],
  ...
  agency: {
    ...
    lines: [
      "Perubahan dimulai dari keputusan satu keluarga setiap hari.",
      "1.000 hari pertama bukan tenggat — ia peluang yang hidup setiap hari.",
    ],
    highlight: "setiap hari",
